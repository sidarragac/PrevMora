...
class ContactMethod(Base):
    ...
    portfolio: Mapped[list['Portfolio']] = relationship('Portfolio', back_populates='contact_method')
...
class ContactResult(Base):
    ...
    portfolio: Mapped[list['Portfolio']] = relationship('Portfolio', back_populates='contact_result')
...
class CreditState(Base):
    ...
    credit: Mapped[list['Credit']] = relationship('Credit', back_populates='credit_state')
...
class InstallmentState(Base):
    ...
    installment: Mapped[list['Installment']] = relationship('Installment', back_populates='installment_state')
...
class ManagerZone(Base):
    ...
    manager: Mapped[list['Manager']] = relationship('Manager', back_populates='manager_zone')
...
class PaymentChannel(Base):
    ...
    reconciliation: Mapped[list['Reconciliation']] = relationship('Reconciliation', back_populates='payment_channel')
...
class Credit(Base):
    ...
    credit_state_id: Mapped[int] = mapped_column(ForeignKey('credit_state.id'), nullable=False)
    ...
    credit_state: Mapped['CreditState'] = relationship('CreditState', back_populates='credit')
...
class Manager(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    name: Mapped[str] = mapped_column(String, nullable=False)
    manager_zone_id: Mapped[int] = mapped_column(ForeignKey('manager_zone.id'), nullable=False)

    manager_zone: Mapped['ManagerZone'] = relationship('ManagerZone', back_populates='manager')
...
class Alert(Base):
    ...
    alert_type_id: Mapped[int] = mapped_column(ForeignKey('alert_type.id'), nullable=False)
...
class Installment(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    credit_id: Mapped[int] = mapped_column(ForeignKey('credit.id'), nullable=False)
    installment_state_id: Mapped[int] = mapped_column(ForeignKey('installment_state.id'), nullable=False)
    ...
    installment_state: Mapped['InstallmentState'] = relationship('InstallmentState', back_populates='installment')
...
class Reconciliation(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    payment_channel_id: Mapped[int] = mapped_column(ForeignKey('payment_channel.id'), nullable=False)
    payment_reference: Mapped[int] = mapped_column(ForeignKey('credit.payment_reference'), nullable=False)
    ...
    payment_channel: Mapped['PaymentChannel'] = relationship('PaymentChannel', back_populates='reconciliation')
...
class Portfolio(Base):
    ...
    contact_method_id: Mapped[int] = mapped_column(ForeignKey('contact_method.id'), nullable=False)
    contact_result_id: Mapped[int] = mapped_column(ForeignKey('contact_result.id'), nullable=False)
    ...
    contact_method: Mapped['ContactMethod'] = relationship('ContactMethod', back_populates='portfolio')
