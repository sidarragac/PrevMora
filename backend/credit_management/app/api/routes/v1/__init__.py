...
v1_router.include_router(installment_router, prefix="/installments", tags=["Installments"])
v1_router.include_router(reconciliation_router, prefix="/reconciliations", tags=["Reconciliations"])
