...
def test_payment_initialization(
    base_url: str, client_id: int, credit_id: Optional[int] = None
) -> bool:
    """
...
def main():
    ...
    parser.add_argument(
        "--client-id", type=int, required=True, help="Client ID to test with"
    )

    parser.add_argument("--credit-id", type=int, help="Optional credit ID to test with")
    ...
    success = test_payment_initialization(args.base_url, args.client_id, args.credit_id)
